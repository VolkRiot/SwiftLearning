...
let yourSentence = "My \(nounArray[1]) was eaten by my \(nounArray[6])"
let yourSillySentence = "My \(nounArray[index1]) smells like a total \(nounArray[index2])"
//: ### Exercise 2
...
var whisperString2 = "psst" + ", " + shoutString.lowercased()
//: ### Exercise 3
...
var count:Int = 0
for letter in gString {
    if letter == "g" || letter == "G" {
        count += 1
    }
}
print("Printed out \(count) 💾")
//: ### Exercise 5
...
//desired output = "$5.67"
print("$\(Float(numOfPennies) / Float(100))")
//: # Let or Var?
import UIKit
import Foundation
//: ### Exercise 9
